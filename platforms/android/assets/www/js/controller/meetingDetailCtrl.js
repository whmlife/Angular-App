      ...
      var ipObj1 = {
        callback: function (val) {
          $timeout(function () {
            ...
            console.log($scope.startMs,$scope.endMs);
            ...
            console.log($scope.meetingInfo.starts);
            console.log($scope.meetingInfo.ends);
          }, 100);
        },
